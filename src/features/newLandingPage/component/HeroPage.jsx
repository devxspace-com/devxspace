...
const HeroPage = () => {
  ...
  return (
    <main className=''>
        <div className=" bg-center bg-cover bg-fixed bg-no-repeat h-screen w-full xsm:w-full sm:w-full opacity-[] " style={{backgroundImage: `url(${bg.src})`}}>
        <div className='bg-[#000000]'>
        {isMobile ? <Mobilenav /> : <Navbar />}
        </div>
        <div className='items-center h-[50%] w-[70%] sm:w-full lg:mt-52 xsm:mt-36 mx-auto opacity-[100%]'>
