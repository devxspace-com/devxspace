...
const ComingSoon = () => {
  return (
    <main>
        <section className='flex w-[90%] tabletAir:flex-col mx-auto border-[1px] rounded-lg bg-[#121806] border-[#121806]  shadow-xl pl-6 relative '>
            <div className="w-[50%] smDesktop:w-[100%] pt-10 pb-12 relative z-[1]">
                ...
                <h1 className='text-[58px] leading-[62px] font-bold mobile:text-[34px] mobile:leading-[40px]'>Community Ownned Developer Governed by DAO</h1>
                <p className="text-[24px] mobile:mt-2 text-[#C5C8C7] mobile:text-[16px] mobile:leading-5 leading-8">
...
<p className="text-[24px] mobile:text-[16px] mobile:leading-5 text-[#C5C8C7] tabletAir:w-[100%] leading-8">
